  ...
  return(
    paste0(
      ...
      if(simul_baseline$baseline_available == TRUE & 
         simul_interventions$interventions_available == FALSE & input$tabs == "tab_visualfit") span(strong("Perform Visual Fit:"), p("Adjust ", em("Probability of infection given contact"), " and re-run the baseline until observed cases/deaths loosely fit the predicted reported cases/deaths.")),
      if(simul_baseline$baseline_available == TRUE & 
