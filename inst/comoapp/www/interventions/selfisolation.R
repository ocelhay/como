      ...
      column(width = 3,
             conditionalPanel("input.selfis_switch",
                              dropdownButton(label = "", circle = FALSE, status = "default", size = 'sm', icon = icon("gear"), 
                                             ...
                                             fluidRow(
                                               column(12,
                                                      dateInput("date_selfis_on", label = "Start Date:", value = "2020-02-10", min = "2020-01-01"),
                                                      ...
                                                      sliderInput("selfis_eff", label = "Adherence to self isolation:", value = 65, min = 0, max = 100,
                                                                  step = 1, post = "%", ticks = FALSE),
                                                      # Screening ----
                                                      ...
                                                      conditionalPanel("input.screen_switch",
                                                                       dateInput("date_screen_on", label = "Start Date:", value = "2020-03-25"),
