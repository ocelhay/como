div(class = "interventions", id = 'interventions_cocoon',
    fluidRow(
      column(width = 9,
             materialSwitch(inputId = "cocoon_switch", label = span(icon("house-user"), 'Cocooning the Elderly'), value = FALSE,
                              ...
                              dropdownButton(label = "", circle = FALSE, status = "default", size = 'sm', icon = icon("gear"), 
                                             ...
                                             fluidRow(
                                               column(12,
                                                      ...
                                                      sliderInput("cocoon_eff", label = "Efficacy of elderly cocoon:", value = 95, min = 0, max = 100,
                                                                  step = 1, post = "%", ticks = FALSE),
                                                      sliderInput("cocoon_cov", label = "Coverage of elderly cocoon:", value = 90, min = 0, max = 100,
                                                                  step = 1, post = "%", ticks = FALSE),
                                                      sliderInput("age_cocoon", label = "Minimum age for elderly cocoon:", value = 70, min = 0, max = 100,
