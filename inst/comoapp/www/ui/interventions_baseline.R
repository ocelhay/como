div(
  ...
  conditionalPanel(condition = "true",
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_1)",
                                           sliderInput("baseline_coverage_1", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_1))",
                                           sliderInput("baseline_coverage_1", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_2)",
                                           sliderInput("baseline_coverage_2", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_2))",
                                           sliderInput("baseline_coverage_2", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_3)",
                                           sliderInput("baseline_coverage_3", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_3))",
                                           sliderInput("baseline_coverage_3", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_4)",
                                           sliderInput("baseline_coverage_4", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_4))",
                                           sliderInput("baseline_coverage_4", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_5)",
                                           sliderInput("baseline_coverage_5", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_5))",
                                           sliderInput("baseline_coverage_5", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_6)",
                                           sliderInput("baseline_coverage_6", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_6))",
                                           sliderInput("baseline_coverage_6", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_7)",
                                           sliderInput("baseline_coverage_7", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_7))",
                                           sliderInput("baseline_coverage_7", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_8)",
                                           sliderInput("baseline_coverage_8", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_8))",
                                           sliderInput("baseline_coverage_8", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_9)",
                                           sliderInput("baseline_coverage_9", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_9))",
                                           sliderInput("baseline_coverage_9", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_10)",
                                           sliderInput("baseline_coverage_10", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_10))",
                                           sliderInput("baseline_coverage_10", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_11)",
                                           sliderInput("baseline_coverage_11", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_11))",
                                           sliderInput("baseline_coverage_11", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_12)",
                                           sliderInput("baseline_coverage_12", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_12))",
                                           sliderInput("baseline_coverage_12", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_13)",
                                           sliderInput("baseline_coverage_13", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_13))",
                                           sliderInput("baseline_coverage_13", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_14)",
                                           sliderInput("baseline_coverage_14", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_14))",
                                           sliderInput("baseline_coverage_14", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_15)",
                                           sliderInput("baseline_coverage_15", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_15))",
                                           sliderInput("baseline_coverage_15", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_16)",
                                           sliderInput("baseline_coverage_16", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_16))",
                                           sliderInput("baseline_coverage_16", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_17)",
                                           sliderInput("baseline_coverage_17", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_17))",
                                           sliderInput("baseline_coverage_17", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_18)",
                                           sliderInput("baseline_coverage_18", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_18))",
                                           sliderInput("baseline_coverage_18", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_19)",
                                           sliderInput("baseline_coverage_19", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_19))",
                                           sliderInput("baseline_coverage_19", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_20)",
                                           sliderInput("baseline_coverage_20", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_20))",
                                           sliderInput("baseline_coverage_20", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_21)",
                                           sliderInput("baseline_coverage_21", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_21))",
                                           sliderInput("baseline_coverage_21", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_22)",
                                           sliderInput("baseline_coverage_22", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_22))",
                                           sliderInput("baseline_coverage_22", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_23)",
                                           sliderInput("baseline_coverage_23", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_23))",
                                           sliderInput("baseline_coverage_23", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_24)",
                                           sliderInput("baseline_coverage_24", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_24))",
                                           sliderInput("baseline_coverage_24", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_25)",
                                           sliderInput("baseline_coverage_25", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_25))",
                                           sliderInput("baseline_coverage_25", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_26)",
                                           sliderInput("baseline_coverage_26", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_26))",
                                           sliderInput("baseline_coverage_26", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_27)",
                                           sliderInput("baseline_coverage_27", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_27))",
                                           sliderInput("baseline_coverage_27", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_28)",
                                           sliderInput("baseline_coverage_28", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_28))",
                                           sliderInput("baseline_coverage_28", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_29)",
                                           sliderInput("baseline_coverage_29", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_29))",
                                           sliderInput("baseline_coverage_29", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_30)",
                                           sliderInput("baseline_coverage_30", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_30))",
                                           sliderInput("baseline_coverage_30", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_31)",
                                           sliderInput("baseline_coverage_31", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_31))",
                                           sliderInput("baseline_coverage_31", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_32)",
                                           sliderInput("baseline_coverage_32", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_32))",
                                           sliderInput("baseline_coverage_32", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_33)",
                                           sliderInput("baseline_coverage_33", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_33))",
                                           sliderInput("baseline_coverage_33", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_34)",
                                           sliderInput("baseline_coverage_34", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_34))",
                                           sliderInput("baseline_coverage_34", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_35)",
                                           sliderInput("baseline_coverage_35", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_35))",
                                           sliderInput("baseline_coverage_35", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_36)",
                                           sliderInput("baseline_coverage_36", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_36))",
                                           sliderInput("baseline_coverage_36", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_37)",
                                           sliderInput("baseline_coverage_37", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_37))",
                                           sliderInput("baseline_coverage_37", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_38)",
                                           sliderInput("baseline_coverage_38", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_38))",
                                           sliderInput("baseline_coverage_38", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_39)",
                                           sliderInput("baseline_coverage_39", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_39))",
                                           sliderInput("baseline_coverage_39", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_40)",
                                           sliderInput("baseline_coverage_40", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_40))",
                                           sliderInput("baseline_coverage_40", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_41)",
                                           sliderInput("baseline_coverage_41", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_41))",
                                           sliderInput("baseline_coverage_41", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_42)",
                                           sliderInput("baseline_coverage_42", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_42))",
                                           sliderInput("baseline_coverage_42", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_43)",
                                           sliderInput("baseline_coverage_43", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_43))",
                                           sliderInput("baseline_coverage_43", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_44)",
                                           sliderInput("baseline_coverage_44", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_44))",
                                           sliderInput("baseline_coverage_44", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_45)",
                                           sliderInput("baseline_coverage_45", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_45))",
                                           sliderInput("baseline_coverage_45", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_46)",
                                           sliderInput("baseline_coverage_46", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_46))",
                                           sliderInput("baseline_coverage_46", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_47)",
                                           sliderInput("baseline_coverage_47", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_47))",
                                           sliderInput("baseline_coverage_47", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_48)",
                                           sliderInput("baseline_coverage_48", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_48))",
                                           sliderInput("baseline_coverage_48", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_49)",
                                           sliderInput("baseline_coverage_49", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_49))",
                                           sliderInput("baseline_coverage_49", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_50)",
                                           sliderInput("baseline_coverage_50", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_50))",
                                           sliderInput("baseline_coverage_50", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_51)",
                                           sliderInput("baseline_coverage_51", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_51))",
                                           sliderInput("baseline_coverage_51", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_52)",
                                           sliderInput("baseline_coverage_52", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_52))",
                                           sliderInput("baseline_coverage_52", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_53)",
                                           sliderInput("baseline_coverage_53", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_53))",
                                           sliderInput("baseline_coverage_53", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_54)",
                                           sliderInput("baseline_coverage_54", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_54))",
                                           sliderInput("baseline_coverage_54", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_55)",
                                           sliderInput("baseline_coverage_55", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_55))",
                                           sliderInput("baseline_coverage_55", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_56)",
                                           sliderInput("baseline_coverage_56", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_56))",
                                           sliderInput("baseline_coverage_56", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_57)",
                                           sliderInput("baseline_coverage_57", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_57))",
                                           sliderInput("baseline_coverage_57", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_58)",
                                           sliderInput("baseline_coverage_58", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_58))",
                                           sliderInput("baseline_coverage_58", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_59)",
                                           sliderInput("baseline_coverage_59", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_59))",
                                           sliderInput("baseline_coverage_59", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_60)",
                                           sliderInput("baseline_coverage_60", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_60))",
                                           sliderInput("baseline_coverage_60", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_61)",
                                           sliderInput("baseline_coverage_61", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_61))",
                                           sliderInput("baseline_coverage_61", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_62)",
                                           sliderInput("baseline_coverage_62", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_62))",
                                           sliderInput("baseline_coverage_62", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_63)",
                                           sliderInput("baseline_coverage_63", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_63))",
                                           sliderInput("baseline_coverage_63", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_64)",
                                           sliderInput("baseline_coverage_64", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_64))",
                                           sliderInput("baseline_coverage_64", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_65)",
                                           sliderInput("baseline_coverage_65", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_65))",
                                           sliderInput("baseline_coverage_65", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_66)",
                                           sliderInput("baseline_coverage_66", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_66))",
                                           sliderInput("baseline_coverage_66", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_67)",
                                           sliderInput("baseline_coverage_67", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_67))",
                                           sliderInput("baseline_coverage_67", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_68)",
                                           sliderInput("baseline_coverage_68", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_68))",
                                           sliderInput("baseline_coverage_68", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_69)",
                                           sliderInput("baseline_coverage_69", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_69))",
                                           sliderInput("baseline_coverage_69", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_70)",
                                           sliderInput("baseline_coverage_70", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_70))",
                                           sliderInput("baseline_coverage_70", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_71)",
                                           sliderInput("baseline_coverage_71", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_71))",
                                           sliderInput("baseline_coverage_71", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_72)",
                                           sliderInput("baseline_coverage_72", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_72))",
                                           sliderInput("baseline_coverage_72", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_73)",
                                           sliderInput("baseline_coverage_73", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_73))",
                                           sliderInput("baseline_coverage_73", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_74)",
                                           sliderInput("baseline_coverage_74", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_74))",
                                           sliderInput("baseline_coverage_74", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_75)",
                                           sliderInput("baseline_coverage_75", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_75))",
                                           sliderInput("baseline_coverage_75", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_76)",
                                           sliderInput("baseline_coverage_76", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_76))",
                                           sliderInput("baseline_coverage_76", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_77)",
                                           sliderInput("baseline_coverage_77", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_77))",
                                           sliderInput("baseline_coverage_77", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_78)",
                                           sliderInput("baseline_coverage_78", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_78))",
                                           sliderInput("baseline_coverage_78", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_79)",
                                           sliderInput("baseline_coverage_79", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_79))",
                                           sliderInput("baseline_coverage_79", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_80)",
                                           sliderInput("baseline_coverage_80", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_80))",
                                           sliderInput("baseline_coverage_80", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_81)",
                                           sliderInput("baseline_coverage_81", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_81))",
                                           sliderInput("baseline_coverage_81", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_82)",
                                           sliderInput("baseline_coverage_82", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_82))",
                                           sliderInput("baseline_coverage_82", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_83)",
                                           sliderInput("baseline_coverage_83", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_83))",
                                           sliderInput("baseline_coverage_83", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_84)",
                                           sliderInput("baseline_coverage_84", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_84))",
                                           sliderInput("baseline_coverage_84", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_85)",
                                           sliderInput("baseline_coverage_85", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_85))",
                                           sliderInput("baseline_coverage_85", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_86)",
                                           sliderInput("baseline_coverage_86", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_86))",
                                           sliderInput("baseline_coverage_86", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_87)",
                                           sliderInput("baseline_coverage_87", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_87))",
                                           sliderInput("baseline_coverage_87", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_88)",
                                           sliderInput("baseline_coverage_88", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_88))",
                                           sliderInput("baseline_coverage_88", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_89)",
                                           sliderInput("baseline_coverage_89", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_89))",
                                           sliderInput("baseline_coverage_89", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_90)",
                                           sliderInput("baseline_coverage_90", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_90))",
                                           sliderInput("baseline_coverage_90", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_91)",
                                           sliderInput("baseline_coverage_91", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_91))",
                                           sliderInput("baseline_coverage_91", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_92)",
                                           sliderInput("baseline_coverage_92", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_92))",
                                           sliderInput("baseline_coverage_92", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_93)",
                                           sliderInput("baseline_coverage_93", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_93))",
                                           sliderInput("baseline_coverage_93", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_94)",
                                           sliderInput("baseline_coverage_94", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_94))",
                                           sliderInput("baseline_coverage_94", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_95)",
                                           sliderInput("baseline_coverage_95", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_95))",
                                           sliderInput("baseline_coverage_95", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_96)",
                                           sliderInput("baseline_coverage_96", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_96))",
                                           sliderInput("baseline_coverage_96", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_97)",
                                           sliderInput("baseline_coverage_97", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_97))",
                                           sliderInput("baseline_coverage_97", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_98)",
                                           sliderInput("baseline_coverage_98", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_98))",
                                           sliderInput("baseline_coverage_98", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_99)",
                                           sliderInput("baseline_coverage_99", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_99))",
                                           sliderInput("baseline_coverage_99", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(2, conditionalPanel("['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_100)",
                                           sliderInput("baseline_coverage_100", NULL, min = 0, max = 3, value = new_coverage_value, ticks = FALSE)),
                             conditionalPanel("!(['Transmissibility', 'Lethality', 'Breakthrough infection probability'].includes(input.baseline_intervention_100))",
                                           sliderInput("baseline_coverage_100", NULL, min = 0, max = 100, value = new_coverage_value, ticks = FALSE))),
