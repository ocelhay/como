div(
  ...
  conditionalPanel(condition = "true",
                 fluidRow(
                   column(1, "#1"),
                   column(3, selectInput("future_intervention_1", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_1", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#2"),
                   column(3, selectInput("future_intervention_2", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_2", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#3"),
                   column(3, selectInput("future_intervention_3", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_3", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#4"),
                   column(3, selectInput("future_intervention_4", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_4", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#5"),
                   column(3, selectInput("future_intervention_5", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_5", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#6"),
                   column(3, selectInput("future_intervention_6", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_6", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#7"),
                   column(3, selectInput("future_intervention_7", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_7", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#8"),
                   column(3, selectInput("future_intervention_8", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_8", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#9"),
                   column(3, selectInput("future_intervention_9", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_9", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#10"),
                   column(3, selectInput("future_intervention_10", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_10", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#11"),
                   column(3, selectInput("future_intervention_11", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_11", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#12"),
                   column(3, selectInput("future_intervention_12", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_12", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#13"),
                   column(3, selectInput("future_intervention_13", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_13", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#14"),
                   column(3, selectInput("future_intervention_14", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_14", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#15"),
                   column(3, selectInput("future_intervention_15", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_15", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#16"),
                   column(3, selectInput("future_intervention_16", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_16", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#17"),
                   column(3, selectInput("future_intervention_17", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_17", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#18"),
                   column(3, selectInput("future_intervention_18", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_18", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#19"),
                   column(3, selectInput("future_intervention_19", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_19", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#20"),
                   column(3, selectInput("future_intervention_20", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_20", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#21"),
                   column(3, selectInput("future_intervention_21", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_21", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#22"),
                   column(3, selectInput("future_intervention_22", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_22", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#23"),
                   column(3, selectInput("future_intervention_23", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_23", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#24"),
                   column(3, selectInput("future_intervention_24", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_24", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#25"),
                   column(3, selectInput("future_intervention_25", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_25", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#26"),
                   column(3, selectInput("future_intervention_26", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_26", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#27"),
                   column(3, selectInput("future_intervention_27", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_27", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#28"),
                   column(3, selectInput("future_intervention_28", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_28", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#29"),
                   column(3, selectInput("future_intervention_29", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_29", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#30"),
                   column(3, selectInput("future_intervention_30", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_30", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#31"),
                   column(3, selectInput("future_intervention_31", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_31", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#32"),
                   column(3, selectInput("future_intervention_32", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_32", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#33"),
                   column(3, selectInput("future_intervention_33", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_33", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#34"),
                   column(3, selectInput("future_intervention_34", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_34", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#35"),
                   column(3, selectInput("future_intervention_35", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_35", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#36"),
                   column(3, selectInput("future_intervention_36", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_36", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#37"),
                   column(3, selectInput("future_intervention_37", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_37", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#38"),
                   column(3, selectInput("future_intervention_38", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_38", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#39"),
                   column(3, selectInput("future_intervention_39", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_39", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#40"),
                   column(3, selectInput("future_intervention_40", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_40", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#41"),
                   column(3, selectInput("future_intervention_41", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_41", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#42"),
                   column(3, selectInput("future_intervention_42", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_42", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#43"),
                   column(3, selectInput("future_intervention_43", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_43", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#44"),
                   column(3, selectInput("future_intervention_44", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_44", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#45"),
                   column(3, selectInput("future_intervention_45", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_45", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#46"),
                   column(3, selectInput("future_intervention_46", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_46", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#47"),
                   column(3, selectInput("future_intervention_47", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_47", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#48"),
                   column(3, selectInput("future_intervention_48", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_48", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#49"),
                   column(3, selectInput("future_intervention_49", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_49", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#50"),
                   column(3, selectInput("future_intervention_50", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_50", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#51"),
                   column(3, selectInput("future_intervention_51", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_51", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#52"),
                   column(3, selectInput("future_intervention_52", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_52", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#53"),
                   column(3, selectInput("future_intervention_53", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_53", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#54"),
                   column(3, selectInput("future_intervention_54", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_54", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#55"),
                   column(3, selectInput("future_intervention_55", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_55", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#56"),
                   column(3, selectInput("future_intervention_56", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_56", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#57"),
                   column(3, selectInput("future_intervention_57", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_57", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#58"),
                   column(3, selectInput("future_intervention_58", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_58", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#59"),
                   column(3, selectInput("future_intervention_59", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_59", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#60"),
                   column(3, selectInput("future_intervention_60", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_60", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#61"),
                   column(3, selectInput("future_intervention_61", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_61", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#62"),
                   column(3, selectInput("future_intervention_62", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_62", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#63"),
                   column(3, selectInput("future_intervention_63", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_63", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#64"),
                   column(3, selectInput("future_intervention_64", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_64", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#65"),
                   column(3, selectInput("future_intervention_65", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_65", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#66"),
                   column(3, selectInput("future_intervention_66", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_66", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#67"),
                   column(3, selectInput("future_intervention_67", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_67", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#68"),
                   column(3, selectInput("future_intervention_68", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_68", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#69"),
                   column(3, selectInput("future_intervention_69", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_69", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#70"),
                   column(3, selectInput("future_intervention_70", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_70", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#71"),
                   column(3, selectInput("future_intervention_71", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_71", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#72"),
                   column(3, selectInput("future_intervention_72", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_72", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#73"),
                   column(3, selectInput("future_intervention_73", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_73", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#74"),
                   column(3, selectInput("future_intervention_74", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_74", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#75"),
                   column(3, selectInput("future_intervention_75", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_75", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#76"),
                   column(3, selectInput("future_intervention_76", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_76", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#77"),
                   column(3, selectInput("future_intervention_77", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_77", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#78"),
                   column(3, selectInput("future_intervention_78", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_78", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#79"),
                   column(3, selectInput("future_intervention_79", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_79", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#80"),
                   column(3, selectInput("future_intervention_80", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_80", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#81"),
                   column(3, selectInput("future_intervention_81", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_81", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#82"),
                   column(3, selectInput("future_intervention_82", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_82", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#83"),
                   column(3, selectInput("future_intervention_83", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_83", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#84"),
                   column(3, selectInput("future_intervention_84", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_84", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#85"),
                   column(3, selectInput("future_intervention_85", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_85", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#86"),
                   column(3, selectInput("future_intervention_86", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_86", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#87"),
                   column(3, selectInput("future_intervention_87", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_87", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#88"),
                   column(3, selectInput("future_intervention_88", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_88", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#89"),
                   column(3, selectInput("future_intervention_89", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_89", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#90"),
                   column(3, selectInput("future_intervention_90", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_90", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#91"),
                   column(3, selectInput("future_intervention_91", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_91", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#92"),
                   column(3, selectInput("future_intervention_92", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_92", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#93"),
                   column(3, selectInput("future_intervention_93", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_93", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#94"),
                   column(3, selectInput("future_intervention_94", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_94", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#95"),
                   column(3, selectInput("future_intervention_95", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_95", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#96"),
                   column(3, selectInput("future_intervention_96", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_96", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#97"),
                   column(3, selectInput("future_intervention_97", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_97", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#98"),
                   column(3, selectInput("future_intervention_98", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_98", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#99"),
                   column(3, selectInput("future_intervention_99", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_99", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
...
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   column(1, "#100"),
                   column(3, selectInput("future_intervention_100", NULL, all_interventions, selected = "_")),
                   ...
                   column(2, sliderInput("future_coverage_100", NULL, min = 0, max = 100, value = 0, ticks = FALSE)),
