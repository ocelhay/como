div(
  ...
  conditionalPanel("output.future_nb >= 1", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_1", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 2", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_2", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 3", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_3", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 4", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_4", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 5", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_5", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 6", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_6", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 7", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_7", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 8", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_8", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 9", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_9", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 10", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_10", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 11", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_11", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 12", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_12", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 13", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_13", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 14", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_14", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 15", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_15", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 16", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_16", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 17", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_17", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 18", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_18", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 19", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_19", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 20", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_20", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 21", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_21", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 22", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_22", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 23", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_23", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 24", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_24", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 25", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_25", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 26", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_26", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 27", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_27", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 28", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_28", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 29", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_29", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
  ...
  conditionalPanel("output.future_nb >= 30", fluidRow(
    ...
    column(5, dateRangeInput("future_daterange_30", NULL, start = new_daterange_value[1], end = new_daterange_value[2], format = "yy-mm-dd", startview = "year")),
