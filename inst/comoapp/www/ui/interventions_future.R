div(
  ...
  conditionalPanel(condition = "true",
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_1)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_1)", 
                                              pickerInput("future_age_group_1", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_2)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_2)", 
                                              pickerInput("future_age_group_2", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_3)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_3)", 
                                              pickerInput("future_age_group_3", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_4)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_4)", 
                                              pickerInput("future_age_group_4", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_5)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_5)", 
                                              pickerInput("future_age_group_5", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_6)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_6)", 
                                              pickerInput("future_age_group_6", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_7)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_7)", 
                                              pickerInput("future_age_group_7", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_8)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_8)", 
                                              pickerInput("future_age_group_8", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_9)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_9)", 
                                              pickerInput("future_age_group_9", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_10)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_10)", 
                                              pickerInput("future_age_group_10", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_11)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_11)", 
                                              pickerInput("future_age_group_11", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_12)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_12)", 
                                              pickerInput("future_age_group_12", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_13)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_13)", 
                                              pickerInput("future_age_group_13", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_14)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_14)", 
                                              pickerInput("future_age_group_14", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_15)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_15)", 
                                              pickerInput("future_age_group_15", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_16)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_16)", 
                                              pickerInput("future_age_group_16", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_17)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_17)", 
                                              pickerInput("future_age_group_17", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_18)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_18)", 
                                              pickerInput("future_age_group_18", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_19)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_19)", 
                                              pickerInput("future_age_group_19", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_20)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_20)", 
                                              pickerInput("future_age_group_20", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_21)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_21)", 
                                              pickerInput("future_age_group_21", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_22)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_22)", 
                                              pickerInput("future_age_group_22", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_23)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_23)", 
                                              pickerInput("future_age_group_23", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_24)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_24)", 
                                              pickerInput("future_age_group_24", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_25)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_25)", 
                                              pickerInput("future_age_group_25", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_26)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_26)", 
                                              pickerInput("future_age_group_26", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_27)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_27)", 
                                              pickerInput("future_age_group_27", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_28)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_28)", 
                                              pickerInput("future_age_group_28", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_29)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_29)", 
                                              pickerInput("future_age_group_29", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_30)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_30)", 
                                              pickerInput("future_age_group_30", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_31)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_31)", 
                                              pickerInput("future_age_group_31", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_32)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_32)", 
                                              pickerInput("future_age_group_32", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_33)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_33)", 
                                              pickerInput("future_age_group_33", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_34)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_34)", 
                                              pickerInput("future_age_group_34", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_35)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_35)", 
                                              pickerInput("future_age_group_35", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_36)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_36)", 
                                              pickerInput("future_age_group_36", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_37)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_37)", 
                                              pickerInput("future_age_group_37", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_38)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_38)", 
                                              pickerInput("future_age_group_38", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_39)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_39)", 
                                              pickerInput("future_age_group_39", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_40)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_40)", 
                                              pickerInput("future_age_group_40", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_41)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_41)", 
                                              pickerInput("future_age_group_41", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_42)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_42)", 
                                              pickerInput("future_age_group_42", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_43)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_43)", 
                                              pickerInput("future_age_group_43", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_44)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_44)", 
                                              pickerInput("future_age_group_44", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_45)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_45)", 
                                              pickerInput("future_age_group_45", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_46)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_46)", 
                                              pickerInput("future_age_group_46", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_47)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_47)", 
                                              pickerInput("future_age_group_47", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_48)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_48)", 
                                              pickerInput("future_age_group_48", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_49)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_49)", 
                                              pickerInput("future_age_group_49", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_50)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_50)", 
                                              pickerInput("future_age_group_50", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_51)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_51)", 
                                              pickerInput("future_age_group_51", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_52)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_52)", 
                                              pickerInput("future_age_group_52", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_53)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_53)", 
                                              pickerInput("future_age_group_53", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_54)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_54)", 
                                              pickerInput("future_age_group_54", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_55)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_55)", 
                                              pickerInput("future_age_group_55", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_56)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_56)", 
                                              pickerInput("future_age_group_56", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_57)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_57)", 
                                              pickerInput("future_age_group_57", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_58)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_58)", 
                                              pickerInput("future_age_group_58", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_59)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_59)", 
                                              pickerInput("future_age_group_59", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_60)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_60)", 
                                              pickerInput("future_age_group_60", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_61)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_61)", 
                                              pickerInput("future_age_group_61", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_62)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_62)", 
                                              pickerInput("future_age_group_62", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_63)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_63)", 
                                              pickerInput("future_age_group_63", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_64)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_64)", 
                                              pickerInput("future_age_group_64", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_65)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_65)", 
                                              pickerInput("future_age_group_65", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_66)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_66)", 
                                              pickerInput("future_age_group_66", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_67)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_67)", 
                                              pickerInput("future_age_group_67", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_68)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_68)", 
                                              pickerInput("future_age_group_68", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_69)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_69)", 
                                              pickerInput("future_age_group_69", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_70)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_70)", 
                                              pickerInput("future_age_group_70", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_71)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_71)", 
                                              pickerInput("future_age_group_71", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_72)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_72)", 
                                              pickerInput("future_age_group_72", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_73)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_73)", 
                                              pickerInput("future_age_group_73", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_74)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_74)", 
                                              pickerInput("future_age_group_74", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_75)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_75)", 
                                              pickerInput("future_age_group_75", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_76)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_76)", 
                                              pickerInput("future_age_group_76", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_77)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_77)", 
                                              pickerInput("future_age_group_77", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_78)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_78)", 
                                              pickerInput("future_age_group_78", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_79)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_79)", 
                                              pickerInput("future_age_group_79", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_80)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_80)", 
                                              pickerInput("future_age_group_80", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_81)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_81)", 
                                              pickerInput("future_age_group_81", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_82)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_82)", 
                                              pickerInput("future_age_group_82", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_83)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_83)", 
                                              pickerInput("future_age_group_83", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_84)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_84)", 
                                              pickerInput("future_age_group_84", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_85)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_85)", 
                                              pickerInput("future_age_group_85", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_86)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_86)", 
                                              pickerInput("future_age_group_86", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_87)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_87)", 
                                              pickerInput("future_age_group_87", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_88)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_88)", 
                                              pickerInput("future_age_group_88", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_89)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_89)", 
                                              pickerInput("future_age_group_89", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_90)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_90)", 
                                              pickerInput("future_age_group_90", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_91)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_91)", 
                                              pickerInput("future_age_group_91", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_92)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_92)", 
                                              pickerInput("future_age_group_92", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_93)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_93)", 
                                              pickerInput("future_age_group_93", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_94)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_94)", 
                                              pickerInput("future_age_group_94", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_95)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_95)", 
                                              pickerInput("future_age_group_95", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_96)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_96)", 
                                              pickerInput("future_age_group_96", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_97)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_97)", 
                                              pickerInput("future_age_group_97", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_98)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_98)", 
                                              pickerInput("future_age_group_98", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_99)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_99)", 
                                              pickerInput("future_age_group_99", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
conditionalPanel(condition = paste0("!([", 
                 ...
                 fluidRow(
                   ...
                   column(3, conditionalPanel("['Mass Testing', 'Vaccination'].includes(input.future_intervention_100)", 
                            ...
                            conditionalPanel("['School Closures'].includes(input.future_intervention_100)", 
                                              pickerInput("future_age_group_100", NULL, choices = vec_age_categories[1:4], selected = vec_age_categories[1:4], options = list(`actions-box` = TRUE, size = 10, `selected-text-format` = "count > 3"), multiple = TRUE))
                                              )
                 )
),
)