...
|---------------------------------------|-------------------------------------------------------------------------------------------------------------------|----------------------------------|
| General                               | Date range of simulation - START                                                                                  | `r input$date_range_simul_start` |
| General                               | Date range of simulation - END                                                                                    | `r input$date_range_simul_end`   |
| General                               | (v16.2) Density of exposed people at start date (expressed as 1/X)                                                | `r input$init`                   |
| General                               | (v16.2) Proportion of population with partial immunity at the start date                                          | `r input$pre`                    |
...
| General                               | (v16.2) Percentage of denied hospitalisations that are reported                                                   | `r input$reporth_g`              |
| General                               | (v16.2) Percentage of non-severe hospitalisations that are appropriately treated                                  | `r input$reporth`                |
| General                               | (v16.2) Percentage of severe hospitalisations that are appropriately treated                                      | `r input$reporth_ICU`            |
| General                               | (v16.2) Percentage of all asymptomatic infections in previously vaccinated people that are reported               | `r input$report_v`               |
| General                               | (v16.2) Percentage of all asymptomatic infections in previously vaccinated and exposed people that are reported   | `r input$report_vr`              |
| General                               | (v16.2) Percentage of all asymptomatic infections in previously infected people that are reported                 | `r input$report_r`               |
| General                               | (v16.2) Percentage of all symptomatic infections in previously vaccinated people that are reported                | `r input$report_cv`              |
| General                               | (v16.2) Percentage of all symptomatic infections in previously vaccinated and exposed people that are reported    | `r input$report_cvr`             |
| General                               | (v16.2) Percentage of all symptomatic infections in previously infected people that are reported                  | `r input$report_cr`              |
| General                               | (v16.2) Percentage of all people dying outside the hospital with asymptomatic infections reported as covid-deaths | `r input$report_natdeathI`       |
| General                               | (v16.2) Percentage of all people dying outside the hospital with symptomatic infections reported as covid-deaths  | `r input$report_natdeathCL`      |
| General                               | (v16.2) Percentage of all people dying outside the hospital with severe infections reported as covid-deaths       | `r input$report_death_HC`        |
| General                               | Iterations (1 to 10,000)                                                                                          | `r input$iterations`             |
| General                               | Noise (0.01 to 0.2)                                                                                               | `r input$noise`                  |
| General                               | Confidence (5 to 25)                                                                                              | `r input$confidence`             |
...
| Virus                                 | Proportion of hospitalised patients needing O2                                                                    | `r input$propo2`                 |
| Virus                                 | (v16.2) Probability upon infection of developing clinical symptoms if previously vaccinated                       | `r input$pclin_v`                |
| Virus                                 | (v16.2) Probability upon infection of developing clinical symptoms if previously vaccinated and exposed           | `r input$pclin_vr`               |
| Virus                                 | (v16.2) Probability upon infection of developing clinical symptoms if previously infected                         | `r input$pclin_r`                |
| Virus                                 | (v16.2) Probability upon hospitalisation of requiring ICU admission if previously vaccinated                      | `r input$prob_icu_v`             |
| Virus                                 | (v16.2) Probability upon hospitalisation of requiring ICU admission if previously vaccinated and exposed          | `r input$prob_icu_vr`            |
| Virus                                 |  (v16.2) Probability upon hospitalisation of requiring ICU admission if previously infected                       | `r input$prob_icu_r`             |
| Virus                                 | (v16.2) Probability upon admission to the ICU of requiring a ventilator if previously vaccinated                  | `r input$prob_v_v`               |
| Virus                                 | (v16.2) Probability upon admission to the ICU of requiring a ventilator if previously vaccinated and exposed      | `r input$prob_v_vr`              |
| Virus                                 | (v16.2) Probability upon admission to the ICU of requiring a ventilator if previously infected                    | `r input$prob_v_r`               |
| Virus                                 | (v16.2) Probability of infection of people that have recovered from a previous infection                          | `r input$sigmaR`                 |
| Virus                                 | (v16.2) Change in probability of requiring hospitalisation if previously vaccinated                               | `r input$sigmaEV`                |
| Virus                                 | (v16.2) Change in probability of requiring hospitalisation if previously infected                                 | `r input$sigmaER`                |
| Virus                                 | (v16.2) Change in probability of requiring hospitalisation if previously infected and vaccinated                  | `r input$sigmaEVR`               |
| Virus                                 | (v16.2) Days from seropositve to seronegative                                                                     | `r input$seroneg`                |
...
| Hospitalisation                       | Scaling factor for infection hospitalisation rate: (0.1 to 5)                                                     | `r input$ihr_scaling`            |
| Hospitalisation                       | Probability of dying when hospitalised (not req O2):                                                              | `r input$pdeath_h`               |
| Hospitalisation                       | Probability of dying when hospitalised if req O2:                                                                 | `r input$pdeath_ho`              |
| Hospitalisation                       | Probability of dying when denied hospitalisation (not req O2):                                                    | `r input$pdeath_hc`              |
| Hospitalisation                       | Probability of dying when denied hospitalisation if req O2:                                                       | `r input$pdeath_hco`             |
| Hospitalisation                       | Probability of dying when admitted to ICU (not req O2):                                                           | `r input$pdeath_icu`             |
| Hospitalisation                       | Probability of dying when admitted to ICU if req O2:                                                              | `r input$pdeath_icuo`            |
| Hospitalisation                       | Probability of dying when admission to ICU denied (not req O2):                                                   | `r input$pdeath_icuc`            |
| Hospitalisation                       | Probability of dying when admission to ICU denied if req O2:                                                      | `r input$pdeath_icuco`           |
...
| Hospitalisation                       | (v16.2) Probability of dying when ventilator required and not going to hospital:                                  | `r input$pdeath_vent_hc`         |
| Hospitalisation                       | (v16.2) Probability of dying when icu required (not O2) and not going to hospital:                                | `r input$pdeath_icu_hc`          |
| Hospitalisation                       | (v16.2) Probability of dying when icu required (req O2) and not going to hospital:                                | `r input$pdeath_icu_hco`         |
...
| Vaccination                           | Minimum age for vaccination                                                                                       | `r input$age_vaccine_min`        |
| Vaccination                           | (v16.2) Maximum Age for vaccination                                                                               | `r input$age_vaccine_max`        |
...
| Mass Testing                          | Minimum age for mass testing (0 to 100)                                                                           | `r input$age_testing_min`        |
| Mass Testing                          | Maximum age for mass testing (0 to 100)                                                                           | `r input$age_testing_max`        |
