div(
  ...
  conditionalPanel("output.baseline_nb >= 6", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_6", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_6", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 7", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_7", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_7", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 8", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_8", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_8", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 9", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_9", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_9", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 10", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_10", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_10", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 11", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_11", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_11", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 12", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_12", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_12", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 13", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_13", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_13", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 14", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_14", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_14", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 15", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_15", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_15", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 16", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_16", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_16", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 17", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_17", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_17", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 18", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_18", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_18", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 19", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_19", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_19", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 20", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_20", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_20", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 21", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_21", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_21", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 22", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_22", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_22", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 23", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_23", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_23", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 24", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_24", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_24", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 25", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_25", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_25", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 26", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_26", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_26", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 27", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_27", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_27", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 28", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_28", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_28", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
  conditionalPanel("output.baseline_nb >= 29", fluidRow(
    ...
    column(5, dateRangeInput("baseline_daterange_29", NULL, start = new_daterange_value[1], end = new_daterange_value[2])),
    column(3, numericInput("baseline_coverage_29", NULL, min = 0, max = 100, value = new_coverage_value))
  )),
